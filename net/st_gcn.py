...
class Model(nn.Module):
    ...
    def __init__(self, in_channels, num_class, graph_args, edge_importance_weighting, **kwargs):
        ...
        # linear layer  这块的out_features 决定该模型的数据输出维度，为什么是1，不是2？  如果loss是BCEWithLogitsLoss 输出feature是1
        # 如果loss 是 CrossEntropyLoss，输出feature是num_class
        # self.linear = nn.Linear(256, num_class)

        self.fcn = nn.Conv2d(256, num_class, kernel_size=1)  # 256 -> num_class
